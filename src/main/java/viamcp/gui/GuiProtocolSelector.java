...
public class GuiProtocolSelector extends GuiScreen {
    ...
    public void drawScreen(int drawScreen, int mouseX, float mouseY) {
        ...
        this.drawCenteredString(this.fontRenderer, EnumChatFormatting.BOLD.toString() + "ViaMCP",this.width / 4, 6, 16777215);
        GL11.glPopMatrix();
    ...
    class SlotList extends GuiSlot {
        ...
        protected void drawSlot(int i, int i1, int i2, int i3, int i4, int i5) {
            drawCenteredString(mc.fontRenderer,(ViaFabric.clientSideVersion == ProtocolSorter.getProtocolVersions().get(i).getVersion() ? EnumChatFormatting.GREEN.toString() : EnumChatFormatting.WHITE.toString()) + ProtocolUtils.getProtocolName(ProtocolSorter.getProtocolVersions().get(i).getVersion()) , width / 2, i2 + 2, -1);
        }
    }
}
