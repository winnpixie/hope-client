...
public class AntiBot extends Module {
    private final NumberProperty<Integer> ticksExisted = new NumberProperty<>("TicksExisted", new String[]{"ticks"},
    ...
    public static boolean isBot(EntityPlayer player) {
        AntiBot antiBot = Client.MODULE_MANAGER.get(AntiBot.class);
