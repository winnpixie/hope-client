...
public class HUD extends Module {
    ...
    private void drawArrayList(ScaledResolution display) {
        ...
        for (Module module : enabled) {
            ...
            VisualHelper.MC_GFX.drawSquare(x - 4, y - 2, textWidth + 4, VisualHelper.TXT.getFontHeight() + 4,
                    Client.ACCENT_COLOR);
            VisualHelper.MC_GFX.drawSquare(x - 3, y - 2, textWidth + 3, VisualHelper.TXT.getFontHeight() + 3,
                    0xFF111111);
