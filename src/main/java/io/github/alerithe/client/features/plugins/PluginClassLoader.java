...
public class PluginClassLoader extends URLClassLoader {
    ...
    public PluginClassLoader(Path path, JarFile jar, ClassLoader parent) throws IOException {
    ...
    protected Class<?> findClass(String name) throws ClassNotFoundException {
        ...
        Class<?> result = defineClass(name, classData, 0, classData.length, codeSrc);
        if (result == null) {
